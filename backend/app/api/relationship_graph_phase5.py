...
async def get_graph(user: User = Depends(get_current_user), session: AsyncSession = Depends(get_db)):
...
async def list_nodes(user: User = Depends(get_current_user), session: AsyncSession = Depends(get_db)):
...
async def get_node(node_id: UUID, user: User = Depends(get_current_user), session: AsyncSession = Depends(get_db)):
...
async def delete_node(node_id: UUID, user: User = Depends(get_current_user), session: AsyncSession = Depends(get_db)):
...
async def list_edges(user: User = Depends(get_current_user), session: AsyncSession = Depends(get_db)):
...
async def delete_edge(edge_id: UUID, user: User = Depends(get_current_user), session: AsyncSession = Depends(get_db)):
